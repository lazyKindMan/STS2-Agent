...
from langgraph_sdk.errors import APITimeoutError, RateLimitError, APIError
from openai import api_key, OpenAIError
from tenacity import retry, stop_after_attempt, wait_exponential, retry_if_exception_type, before_sleep_log

from assistant.app.core.config import Settings, settings
    ...
    LLMS : List[Dict[str, Any]] = [
        {
            ...
            "llm": ChatOpenAI(
                ...
                base_url=settings.QIANWEN_API_URL,
                temperature=0.7,
            )
        },
        {
...
class LLMService:
    ...
    def __init__(self):
        ...
        try:
            self._current_model_index = all_names.index(settings.DEFAULT_MODEL)
            self._llm = LLMRegistry.get(settings.DEFAULT_MODEL)
            logger.info(
